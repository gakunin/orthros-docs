...
* [meatmail](https://meatmail.nii.ac.jp/)
* NII研究クラウド
    * [研究クラウド(abc)](https://abc.ecloud.nii.ac.jp/)
    * [研究クラウド(xyz)](https://xyz.ecloud.nii.ac.jp/)
* [NII 研究データ基盤](https://dpauth.ecloud.nii.ac.jp/simplesaml/module.php/core/authenticate.php?as=default-sp)
* [NSI準拠の国際的なオンデマンドネットワークのパス予約サービス](https://requester.nsi.nii.ac.jp/)
* [STEP10聴講申請システム](https://step10.adm.s.u-tokyo.ac.jp/)
* [インタークラウド - Jupyter Notebook](https://nbhub.ecloud.nii.ac.jp/simplesaml/module.php/core/authenticate.php?as=default-sp)
* [科学技術の学術情報共有のための双方向コミュニケーションサービス](https://c.yz.yamagata-u.ac.jp/)
* [学認LMS](https://contents.nii.ac.jp/lms_support)
    * 個人単位の一時的な試用に限り利用可
* 学認クラウドオンデマンド構築サービス
    * このサービスの説明は[こちら](https://cloud.gakunin.jp/ocs/)（ログイン方法は各自ご確認ください）
* [学認クラウドゲートウェイサービス（グループ機能）](https://cg.gakunin.jp/)
* 学認申請システム
...
※公開を希望していないサービスについては掲載を行っておりません。（5件）
